...
class Carro(db.Model):                   # Define a classe Carro como um modelo do SQLAlchemy (herda de db.Model)
    __tablename__ = 'carros'              # Nome da tabela no banco de dados será "carros"
    ...
    def json(self):                                        # Define o método json() que retorna os dados do carro como dicionário
        return {
            ...
            'modelo': self.modelo,    # Retorna o modelo do carro
